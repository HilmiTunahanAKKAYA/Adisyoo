<!-- Operator-specific login page — posts to generic login handler with redirect -->
<!doctype html>
<html lang="tr">
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <title>Operatör Girişi</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
  <link rel="stylesheet" href="assets/style.css">
  <style>
    /* Login card styled like your screenshot but using project's brand colors */
...
<body>
  <div class="login-shell">
    ...
    <form method="post" action="login.php">
      <input type="hidden" name="redirect" value="operator.php">
      <div class="mb-3">
